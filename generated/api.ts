...
export const StoreApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getInventory(options?: RawAxiosRequestConfig): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<{
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createUsersWithArrayInput(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["UserApi.createUsersWithArrayInput"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export class UserApi extends BaseAPI {
  ...
  public createUsersWithArrayInput(user: Array<User>, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .createUsersWithArrayInput(user, options)
      .then((request) => request(this.axios, this.basePath));
  }
